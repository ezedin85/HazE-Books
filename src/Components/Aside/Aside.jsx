    ...
    <div style={window.screen.width <= 480 ? sizeStyle: {}} className="aside">
      ...
      {/* <h1>{props.showMenu? 'got it':'got ittttt'}</h1> */}
        ...
        <div className='aside_links'>
            ...
            <Link to="mailto: ezedin38nuru@gmail.com" ><i className="fa-regular fa-envelope"></i> Contact</Link>
            <Link to="http://ezedinnuru.epizy.com/" ><i className="fa-solid fa-laptop-code"></i> Developer</Link>
